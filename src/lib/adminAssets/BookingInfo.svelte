<script lang="ts">
	...
	// Called with (booking, "paid" | "unpaid") — hook up your API call here
	export let handlePaymentUpdate: (booking: BookingEntry, status: "paid" | "unpaid") => void;
			...
			<div class="space-y-2 sm:space-y-3">
				...
				<div class="flex flex-row gap-2">
					<button
						...
						on:click={() => handlePaymentUpdate(booking, "paid")}
					>
						Mark as Paid
					</button>
					...
					<button
						...
						on:click={() => handlePaymentUpdate(booking, "unpaid")}
					>
						Mark as Not Paid
					</button>
				</div>
